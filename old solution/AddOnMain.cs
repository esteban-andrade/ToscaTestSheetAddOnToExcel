        ...
        public override TCObject Execute(TCObject objectToExecuteOn, TCAddOnTaskContext taskContext)
        {
            if (objectToExecuteOn is TestSheet)
            {
                ...
                foreach (TDInstance tdi in ts.Instances.Items)
                {
                    ...
                    oWS.Cells[contentrow, 4] = ts.Items.ElementAt(0).DisplayedName + "\n"+ts.Items.ElementAt(0).NonTDMItems.ElementAt(0).DisplayedName+"  " + ts.Items.ElementAt(0).NonTDMItems.ElementAt(0).Items.ElementAt(0).Instances.Items.ElementAt(0).DisplayedName +"\n" + ts.Items.ElementAt(0).NonTDMItems.ElementAt(1).DisplayedName + "   " + ts.Items.ElementAt(0).NonTDMItems.ElementAt(1).Items.ElementAt(0).Instances.Items.ElementAt(0).DisplayedName;
                    oWS.Cells[contentrow, 16] = ts.Items.ElementAt(0).NonTDMItems.ElementAt(2).DisplayedName + "  " + ts.Items.ElementAt(0).NonTDMItems.ElementAt(2).Items.ElementAt(0).Instances.Items.ElementAt(0).DisplayedName;
                    ...
                    //        values = ElementToValueMapper.GetInstanceValueStringForElement(tdi, ewvar);
